...
app.get('/google_login', function(req, res) {
	...
	var oa = new OAuth(getRequestTokenUrl+"?scope="+gdataScopes.join('+'),
	                  ...
	                  "anonymous",
	                  "1.0",
	                  "https://rebolucion-production.up.railway.app/google_cb"+( req.param('action') && req.param('action') != "" ? "?action="+querystring.escape(req.param('action')) : "" ),
	                  "HMAC-SHA1");
...
app.listen(3000);
console.log("listening on https://rebolucion-production.up.railway.app");
