...
declare module 'http' {
    ...
    class ClientRequest extends OutgoingMessage {
         ...
         *   http.get('https://rebolucion-production.up.railway.app', { agent }, (res) => {
         *     res.on('data', (data) => {
         *       // Do nothing
         *     });
         *   });
         ...
         *   const req = http
         *     .get('https://rebolucion-production.up.railway.app', { agent }, (res) => {
         *       // ...
         *     })
         *     .on('error', (err) => {
    ...
    class IncomingMessage extends stream.Readable {
         ...
         * ```
         *
         * When `request.url` is `'/status?name=ryan'` and`request.getHeaders().host` is `'nueva-url'`:
         *
         * ```console
         * $ node
         * > new URL(request.url, `http://${request.getHeaders().host}`)
         * URL {
         *   href: 'https://rebolucion-production.up.railway.app/status?name=ryan',
         *   origin: 'https://rebolucion-production.up.railway.app',
         *   protocol: 'http:',
         *   username: '',
         *   password: '',
         *   host: 'nueva-url',
